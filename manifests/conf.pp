...
#
# With this define you can manage any ceilometer configuration file
#
# == Parameters
#
# [*template*]
...
#   Example: template => 'site/ceilometer/my.conf.erb',
#
# [*content*]
...
#   Example: source => 'puppet:///site/ceilometer/my.conf',
#
# [*ensure*]
...
define ceilometer::conf (
  ...
  $manage_path    = pickx($path, "${ceilometer::config_dir_path}/${name}")
  $manage_content = default_content($content, $template)
  $manage_mode    = pickx($mode, $ceilometer::config_file_mode)
  $manage_owner   = pickx($owner, $ceilometer::config_file_owner)
  $manage_group   = pickx($group, $ceilometer::config_file_group)
  $manage_require = pickx($config_file_require, $ceilometer::config_file_require)
